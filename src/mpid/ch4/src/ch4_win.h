...
static inline int MPIDI_Win_set_info(MPIR_Win * win, MPIR_Info * info)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_start(MPIR_Group * group, int assert, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_complete(MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_post(MPIR_Group * group, int assert, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_wait(MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_test(MPIR_Win * win, int *flag)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_lock(int lock_type, int rank, int assert, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_unlock(int rank, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_get_info(MPIR_Win * win, MPIR_Info ** info_p_p)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_free(MPIR_Win ** win_ptr)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_fence(int assert, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_create(void *base,
                                   MPI_Aint length,
                                   int disp_unit,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_attach(MPIR_Win * win, void *base, MPI_Aint size)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_allocate_shared(MPI_Aint size,
                                            int disp_unit,
                                            MPIR_Info * info_ptr,
                                            MPIR_Comm * comm_ptr,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_flush_local(int rank, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_detach(MPIR_Win * win, const void *base)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_shared_query(MPIR_Win * win,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_allocate(MPI_Aint size,
                                     int disp_unit,
                                     MPIR_Info * info,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_flush(int rank, MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_flush_local_all(MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_unlock_all(MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_create_dynamic(MPIR_Info * info, MPIR_Comm * comm, MPIR_Win ** win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_sync(MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_flush_all(MPIR_Win * win)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Win_lock_all(int assert, MPIR_Win * win)
{
    int mpi_errno;
