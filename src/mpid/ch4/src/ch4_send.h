...
static inline int MPIDI_Send(const void *buf,
                             int count,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Isend(const void *buf,
                              int count,
                              MPI_Datatype datatype,
                              int rank,
                              int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Rsend(const void *buf,
                              int count,
                              MPI_Datatype datatype,
                              int rank,
                              int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Irsend(const void *buf,
                               int count,
                               MPI_Datatype datatype,
                               int rank,
                               int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Ssend(const void *buf,
                              int count,
                              MPI_Datatype datatype,
                              int rank,
                              int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Issend(const void *buf,
                               int count,
                               MPI_Datatype datatype,
                               int rank,
                               int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Startall(int count, MPIR_Request * requests[])
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Send_init(const void *buf,
                                  int count,
                                  MPI_Datatype datatype,
                                  int rank,
                                  int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Ssend_init(const void *buf,
                                   int count,
                                   MPI_Datatype datatype,
                                   int rank,
                                   int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Bsend_init(const void *buf,
                                   int count,
                                   MPI_Datatype datatype,
                                   int rank,
                                   int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Rsend_init(const void *buf,
                                   int count,
                                   MPI_Datatype datatype,
                                   int rank,
                                   int tag,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Cancel_send(MPIR_Request * sreq)
{
    int mpi_errno;
