...
static inline int MPIDI_Probe(int source,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Mprobe(int source,
                               int tag,
                               MPIR_Comm * comm,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Improbe(int source,
                                int tag,
                                MPIR_Comm * comm,
                                int context_offset,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_Iprobe(int source,
                               int tag,
