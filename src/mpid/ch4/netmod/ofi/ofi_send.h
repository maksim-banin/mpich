...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_OFI_send_normal(MPIDI_OFI_SENDPARAMS,
                                        int dt_contig,
                                        size_t data_sz,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_OFI_send(MPIDI_OFI_SENDPARAMS, int noreq, uint64_t syncflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_OFI_persistent_send(MPIDI_OFI_SENDPARAMS)
{
    MPIR_Request *sreq;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_send(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_rsend(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_irsend(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_ssend(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_isend(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_issend(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_send_init(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_ssend_init(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_bsend_init(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_NM_mpi_rsend_init(MPIDI_OFI_SENDPARAMS)
{
    int mpi_errno;
