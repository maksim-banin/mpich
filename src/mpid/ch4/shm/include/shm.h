...
static inline int MPIDI_SHM_am_isend(int rank, MPIR_Comm * comm, int handler_id,
                                                ...
                                                void *shm_context);
static inline int MPIDI_SHM_inject_am(int rank, MPIR_Comm * comm, int handler_id,
                                                 const void *am_hdr, size_t am_hdr_sz,
                                                 const void *data, MPI_Count count,
...
static inline int MPIDI_SHM_am_isendv(int rank, MPIR_Comm * comm, int handler_id,
                                                 ...
                                                 MPI_Datatype datatype, MPIR_Request * sreq,
                                                 void *shm_context);
static inline int MPIDI_SHM_inject_amv(int rank, MPIR_Comm * comm, int handler_id,
                                                  struct iovec *am_hdrs, size_t iov_len,
                                                  const void *data, MPI_Count count,
                                                  MPI_Datatype datatype, void *shm_context);
...
static inline int MPIDI_SHM_get_node_id(MPIR_Comm * comm, int rank,
                                                   MPID_Node_id_t * id_p);
...
static inline int MPIDI_SHM_mpi_send(const void *buf, int count, MPI_Datatype datatype,
                                                int rank, int tag, MPIR_Comm * comm,
                                                int context_offset, MPIR_Request ** request);
static inline int MPIDI_SHM_mpi_ssend(const void *buf, int count,
...
static inline int MPIDI_SHM_mpi_bsend_init(const void *buf, int count,
                                                      ...
                                                      MPIR_Comm * comm, int context_offset,
                                                      MPIR_Request ** request);
static inline int MPIDI_SHM_mpi_isend(const void *buf, int count, MPI_Datatype datatype,
                                                 int rank, int tag, MPIR_Comm * comm,
                                                 int context_offset, MPIR_Request ** request);
static inline int MPIDI_SHM_mpi_issend(const void *buf, int count, MPI_Datatype datatype,
                                                  int rank, int tag, MPIR_Comm * comm,
                                                  int context_offset, MPIR_Request ** request);
...
static inline int MPIDI_SHM_mpi_recv_init(void *buf, int count, MPI_Datatype datatype,
                                                     int rank, int tag, MPIR_Comm * comm,
                                                     int context_offset, MPIR_Request ** request);
static inline int MPIDI_SHM_mpi_recv(void *buf, int count, MPI_Datatype datatype,
                                                int rank, int tag, MPIR_Comm * comm,
                                                int context_offset, MPI_Status * status,
                                                MPIR_Request ** request);
static inline int MPIDI_SHM_mpi_irecv(void *buf, int count, MPI_Datatype datatype,
                                                 int rank, int tag, MPIR_Comm * comm,
                                                 int context_offset, MPIR_Request ** request);
static inline int MPIDI_SHM_mpi_imrecv(void *buf, int count, MPI_Datatype datatype,
                                                  MPIR_Request * message, MPIR_Request ** rreqp);
...
static inline int MPIDI_SHM_mpi_put(const void *origin_addr, int origin_count,
                                               ...
                                               MPI_Aint target_disp, int target_count,
                                               MPI_Datatype target_datatype, MPIR_Win * win);
static inline int MPIDI_SHM_mpi_win_start(MPIR_Group * group, int assert,
                                                     MPIR_Win * win);
...
static inline int MPIDI_SHM_mpi_win_lock(int lock_type, int rank, int assert,
                                                    MPIR_Win * win);
...
static inline int MPIDI_SHM_mpi_ineighbor_alltoallw(const void *sendbuf,
                                                    ...
                                                    const MPI_Datatype * recvtypes,
                                                    MPIR_Comm * comm, MPI_Request * req);
static inline int MPIDI_SHM_mpi_ibarrier(MPIR_Comm * comm, MPI_Request * req);
